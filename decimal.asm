...
RETURN_D PROC NEAR
		...
		RET
RETURN_D ENDP
SCANINT_D	PROC NEAR ;Procédure de lecture de caractère + vérification caractère entré
	;output DI
	ASSUME CS:CODE_D,DS:DONNEE_D
		PUSH    AX
		PUSH    BX
		PUSH    CX
		PUSH    DX
...
PROG_MULTIPLICATION_D PROC NEAR
